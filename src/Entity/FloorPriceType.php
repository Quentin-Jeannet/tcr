...
use App\Repository\FloorPriceTypeRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=FloorPriceTypeRepository::class)
 */
class FloorPriceType
{
    // ====================================================== //
    // ===================== PROPRIETES ===================== //
    // ====================================================== //
    ...
    /**
     * @ORM\OneToMany(targetEntity=FloorPrice::class, mappedBy="FloorType")
     */
    private $floorPrices;
    ...
    public function removeFloorPrice(FloorPrice $floorPrice): self
    {
        if ($this->floorPrices->removeElement($floorPrice)) {
            ...
            if ($floorPrice->getFloorType() === $this) {
                $floorPrice->setFloorType(null);
            }
        }
